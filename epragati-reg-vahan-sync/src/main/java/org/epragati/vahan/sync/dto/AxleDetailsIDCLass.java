...
@Embeddable
public class AxleDetailsIDCLass implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 591959216462701931L;
	...
	public AxleDetailsIDCLass() { }


	public AxleDetailsIDCLass(String stateCd, Integer offCd,String regnNo) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AxleDetailsIDCLass other = (AxleDetailsIDCLass) obj;
