...
@Embeddable
public class InsuranceIDCLass implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8526831668344681519L;
	...
	public InsuranceIDCLass() { }


	public InsuranceIDCLass(String stateCd, Integer offCd,String regnNo) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		InsuranceIDCLass other = (InsuranceIDCLass) obj;
