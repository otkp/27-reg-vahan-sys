...
public class OwnerDetailsNicDTO implements Serializable{

	
	private static final long serialVersionUID = -1755962530885829211L;
	...
	public OwnerDetailsNicDTO() { }
	
	public OwnerDetailsNicDTO(OwnerDetailsIDCLass ownerDetailsIDCLass) { 
